...
Credits: Aurora Builder was created by Bas Driessen. This repository is a collection of homebrew content meant for personal use and extension of the Aurora Builder application.
        For the creation of the XML i used this XML from Daeronth as a references- https://github.com/Daeronth/DnD5e-Aurora-Builder/blob/main/fire_elementalist.xml
...
Open Aurora Builder and navigate to Options > Manage Data.
Add the following URL as a content source: (will share when repo is ready)
...
Refer to --> "Fools Gold- Into the Bellowing Wilds" [(https://foolsgold.fun/)]
Contribution
